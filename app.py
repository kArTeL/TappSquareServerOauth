...
@app.route('/')
def authorize():
  return '''<a href="https://connect.squareup.com/oauth2/authorize?client_id={0}&scope=PAYMENTS_WRITE%20PAYMENTS_READ%20ITEMS_READ%20ORDERS_READ%20TIMECARDS_READ%20PAYMENTS_WRITE">Click here</a>
